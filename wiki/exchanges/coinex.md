...
- https://viabtc.github.io/coinex_api_en_doc/futures/#docsfutures001_http033_pending_position
- https://viabtc.github.io/coinex_api_en_doc/futures/#docsfutures001_http033-0_finished_position
...
| params | <code>object</code> | No | extra parameters specific to the exchange API endpoint |
| params.method | <code>string</code> | No | the method to use 'perpetualPrivateGetPositionPending' or 'perpetualPrivateGetPositionFinished' default is 'perpetualPrivateGetPositionPending' |
| params.side | <code>int</code> | No | *history endpoint only* 0: All, 1: Sell, 2: Buy, default is 0 |
