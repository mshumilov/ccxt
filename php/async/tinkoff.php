...
use ccxt\async\abstract\tinkoff as Exchange;
...
class tinkoff extends Exchange {
    ...
    public function fetch_accounts($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->usersPostGetAccounts ($params));
            //
            //   {
            //     "accounts" => array(
            //       {
    ...
    public function fetch_markets($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $etfs = Async\await($this->instrumentsPostEtfs (array_merge($request, $params)));
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->marketdataPostGetLastTrades (array_merge($request, $params)));
            //
            // {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->marketdataPostGetOrderBook (array_merge($request, $params)));
            //
            //   {
            //       "orderbooks":{
            //          "BTC/USD":{
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = 0, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            while (strlen($ohlcvs) < $limit && $i < $maxPrepeats) {
                ...
                $response = Async\await($this->marketdataPostGetCandles (array_merge($request, $params)));
                //
                // { 'candles':
                //   array(
                //     {
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            $order = Async\await($this->ordersPostPostOrder (array_merge($request, $params)));
            //
            //   {
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->ordersPostCancelOrder (array_merge($request, $params)));
            //
            //   {
            //       "code" => 40410000,
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->ordersPostCancelOrder ($params));
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $order = Async\await($this->ordersPostGetOrderState (array_merge($request, $params)));
    ...
    public function fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->ordersPostGetOrders (array_merge($request, $params)));
            //
            //     array(
            //         {
    ...
    public function fetch_balance($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->operationsPostGetWithdrawLimits ($params));
